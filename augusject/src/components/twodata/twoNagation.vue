...
import rightdata4 from "../twodata/rightNavgation3.vue";
import rightdata5 from "../twodata/rightNavgation4.vue";
import rightdata6 from "../twodata/rightNavgation5.vue";
export default {
  name: "WorkspaceJsonTwoNagation",
  components: {},
  data() {
    return {
      str: [
        ...
        {
          imgse: "https://files.codelife.cc/topsearch/WnBe01o371.png",
          name: "微信",
          component: rightdata4
        },
        {
          imgse: "https://files.codelife.cc/topsearch/Q1Vd5Ko85R.png",
          name: "36氪",
          component: rightdata5
        },
        {
          imgse: "https://files.codelife.cc/topsearch/Y2KeDGQdNP.png",
          name: "少数派",
          component: rightdata6
        }
      ],
      activeTab: 0
    };
